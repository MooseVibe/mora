...
- deck currently has 67 cards: 22 major arcana and 45 minor/court cards
...
- latest card addition: `seven-of-swords` / «Семёрка Мечей»; approved visual keeps Rider-Waite-Smith logic of one person quietly carrying five swords away from a camp while two swords remain behind, with a standard integrated `VII` marker and three approved `preview/full/share` readings about disclosure, careful planning and risky shortcuts
...
- cards-first continues in parallel one card per pass; latest pass added `seven-of-swords`; the next pass can be one new card or one old-card update, without changing IDs, draw/save/journal mechanics, or starting `three-of-swords`
