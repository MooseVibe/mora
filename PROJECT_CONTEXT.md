...
- latest visual-unification release added the sixth approved minor batch, `seven-of-wands`, `eight-of-wands`, `ten-of-pentacles`, `nine-of-pentacles`, `nine-of-wands`; release commit `0fb23b8`, production deployment `dpl_7ynuDoRkGzDNBqv9scuCSygSiaTw`. A seventh approved batch — `six-of-swords`, `queen-of-pentacles`, `ace-of-wands`, `queen-of-wands`, `page-of-wands` — is integrated locally, passed technical and manual QA, and has explicit release approval; thirty-five minor/court artworks are now unified locally
