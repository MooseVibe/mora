...
- latest production visual-unification release added the seventh approved minor/court batch, `six-of-swords`, `queen-of-pentacles`, `ace-of-wands`, `queen-of-wands`, `page-of-wands`; release commit `a39ca6d`, production deployment `dpl_7zkcuPgfShFRm6TRstXYG6JAMAtM`. Three further approved local batches bring the unified minor/court total to fifty and are authorized for the next production deploy.
