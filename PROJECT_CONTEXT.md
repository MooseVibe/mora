...
- deck currently has 73 cards: 22 major arcana and 51 minor/court cards
- share-ready cards currently (62): `fool`, `magician`, `high-priestess`, `empress`, `emperor`, `hierophant`, `lovers`, `chariot`, `strength`, `hermit`, `wheel`, `justice`, `hanged-man`, `death`, `temperance`, `devil`, `tower`, `star`, `moon`, `two-of-cups`, `six-of-cups`, `ace-of-swords`, `page-of-cups`, `king-of-cups`, `queen-of-cups`, `king-of-wands`, `queen-of-wands`, `four-of-swords`, `five-of-swords`, `seven-of-swords`, `queen-of-swords`, `king-of-swords`, `three-of-cups`, `four-of-cups`, `five-of-cups`, `ace-of-pentacles`, `two-of-pentacles`, `six-of-pentacles`, `three-of-pentacles`, `four-of-pentacles`, `five-of-pentacles`, `seven-of-pentacles`, `nine-of-pentacles`, `ten-of-pentacles`, `page-of-pentacles`, `king-of-pentacles`, `knight-of-pentacles`, `two-of-wands`, `four-of-wands`, `five-of-wands`, `six-of-wands`, `seven-of-wands`, `eight-of-wands`, `nine-of-wands`, `page-of-wands`, `page-of-swords`, `eight-of-cups`, `ten-of-cups`, `nine-of-cups`, `ten-of-wands`, `nine-of-swords`, `eight-of-swords`
- latest card addition: `knight-of-pentacles` / «Рыцарь Пентаклей»; approved aged-oil visual preserves the Rider-Waite-Smith composition of one armored knight on one stationary dark horse, exactly one pentacle, leafy sprigs, a plowed field and a low horizon; the accepted footer deliberately reuses the full `K`-with-crown marker from `king-of-pentacles`, and the card has three approved `preview/full/share` readings about finishing one stage of a long task, keeping a promise and restoring a repeatable routine
...
- latest old-card update: `moon` / «Луна» received an approved 1024x1536 aged-oil visual with a faced moon, exactly two towers, one collared dog, one wild wolf, one crayfish, a continuous path and the standard integrated `XVIII` marker; its three approved `preview/full/share` readings cover silence after a conversation, checking a suspicious offer and understanding a troubling dream
...
- cards-first continues in parallel one card per pass; the latest pass added `knight-of-pentacles`, while the previous pass updated `moon`; the next pass can be one new card or one old-card update, without changing IDs, draw/save/journal mechanics, or starting `three-of-swords`
