...
- the approved eleventh minor/court regeneration batch plus the final `three-of-swords` pass complete the visual-unification line locally; `world` and `judgement` remain the locked references, and all 78 canonical artworks now follow the approved Mora direction
