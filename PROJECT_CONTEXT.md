...
- latest visual-unification release added the sixth approved minor batch, `seven-of-wands`, `eight-of-wands`, `ten-of-pentacles`, `nine-of-pentacles`, `nine-of-wands`; together with the previous twenty-five, thirty minor/court artworks are now unified; release commit `0fb23b8`, production deployment `dpl_7ynuDoRkGzDNBqv9scuCSygSiaTw`
