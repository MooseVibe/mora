...
- latest visual-unification release added the fifth approved minor batch, `two-of-wands` through `six-of-wands`; together with the previous twenty, twenty-five minor/court artworks are released in commit `361d83b` / deployment `dpl_FCkpFCV6quTbG6YVZ2V3JtnXhGo6`; a sixth approved batch (`seven-of-wands`, `eight-of-wands`, `ten-of-pentacles`, `nine-of-pentacles`, `nine-of-wands`) is integrated locally, technically verified and authorized for commit/production deploy
