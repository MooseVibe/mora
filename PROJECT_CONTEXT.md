...
- deck currently has 60 cards: 22 major arcana and 38 minor/court cards
...
- latest card addition: `nine-of-wands` / «Девятка Жезлов»; approved visual keeps Rider-Waite-Smith logic of one wounded guarded figure, one wand in hands, and eight upright wands behind, with a standard integrated `IX` marker
