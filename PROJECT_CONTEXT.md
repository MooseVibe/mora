...
- deck currently has 71 cards: 22 major arcana and 49 minor/court cards
- share-ready cards currently (59): `fool`, `magician`, `high-priestess`, `empress`, `emperor`, `hierophant`, `lovers`, `chariot`, `strength`, `hermit`, `wheel`, `justice`, `hanged-man`, `death`, `temperance`, `devil`, `tower`, `star`, `two-of-cups`, `six-of-cups`, `ace-of-swords`, `page-of-cups`, `king-of-cups`, `queen-of-cups`, `king-of-wands`, `queen-of-wands`, `four-of-swords`, `five-of-swords`, `seven-of-swords`, `queen-of-swords`, `king-of-swords`, `three-of-cups`, `four-of-cups`, `five-of-cups`, `ace-of-pentacles`, `two-of-pentacles`, `six-of-pentacles`, `three-of-pentacles`, `four-of-pentacles`, `five-of-pentacles`, `seven-of-pentacles`, `nine-of-pentacles`, `ten-of-pentacles`, `page-of-pentacles`, `king-of-pentacles`, `two-of-wands`, `four-of-wands`, `five-of-wands`, `six-of-wands`, `seven-of-wands`, `eight-of-wands`, `nine-of-wands`, `page-of-wands`, `page-of-swords`, `eight-of-cups`, `ten-of-cups`, `nine-of-cups`, `ten-of-wands`, `nine-of-swords`
- latest card addition: `king-of-pentacles` / «Король Пентаклей»; approved aged-oil visual keeps Rider-Waite-Smith logic of one mature king on a dark stone throne with bull carvings, exactly one pentacle and one sceptre, grapevines, a garden and a castle; the accepted shared `K` + crown geometry was transferred from the existing Kings, and the card has three approved scene-first `preview/full/share` readings about taking responsibility with enough time, budget and authority, maintaining what should last and naming the price of one's work
- latest old-card update: `star` / «Звезда» received an approved 1024x1536 aged-oil visual with one clothed kneeling woman, two ewers pouring into water and onto land, one large star plus seven smaller stars, one bird in one tree and the standard integrated `XVII` marker; its three approved scene-first `preview/full/share` readings cover recovery after an overworked period, returning to a project after failure and reopening an important relationship after a quarrel
...
- cards-first continues in parallel one card per pass; latest pass updated `star`, while the previous pass added `king-of-pentacles`; the next pass can be one new card or one old-card update, without changing IDs, draw/save/journal mechanics, or starting `three-of-swords`
