...
- deck currently has 70 cards: 22 major arcana and 48 minor/court cards
- share-ready cards currently: `fool`, `magician`, `high-priestess`, `empress`, `emperor`, `hierophant`, `lovers`, `chariot`, `strength`, `hermit`, `wheel`, `justice`, `hanged-man`, `death`, `temperance`, `devil`, `tower`, `two-of-cups`, `six-of-cups`, `ace-of-swords`, `page-of-cups`, `king-of-cups`, `queen-of-cups`, `king-of-wands`, `queen-of-wands`, `four-of-swords`, `five-of-swords`, `seven-of-swords`, `queen-of-swords`, `king-of-swords`, `three-of-cups`, `four-of-cups`, `five-of-cups`, `ace-of-pentacles`, `two-of-pentacles`, `six-of-pentacles`, `three-of-pentacles`, `four-of-pentacles`, `five-of-pentacles`, `seven-of-pentacles`, `nine-of-pentacles`, `ten-of-pentacles`, `page-of-pentacles`, `two-of-wands`, `four-of-wands`, `five-of-wands`, `six-of-wands`, `seven-of-wands`, `eight-of-wands`, `nine-of-wands`, `page-of-wands`, `page-of-swords`, `eight-of-cups`, `ten-of-cups`, `nine-of-cups`, `ten-of-wands`, `nine-of-swords`
- latest card addition: `page-of-pentacles` / «Паж Пентаклей»; approved visual keeps Rider-Waite-Smith logic of one young page studying exactly one pentacle in a flowering field, with a grove, ploughed ground and distant mountains; the accepted complete `P` + crown marker was transferred from `page-of-wands`, and the card has three approved scene-first `preview/full/share` readings about learning a skill, checking a purchase or subscription and handling an unfamiliar work task
- latest old-card update: `devil` / «Дьявол» received approved `preview/full/share` texts and a new 1024x1536 visual with the horned figure, inverted pentagram, downward torch, two clothed figures with separate loose chains, grape/flame tails and the standard integrated `XV` marker
...
- cards-first continues in parallel one card per pass; latest pass added `page-of-pentacles`; the next pass can be one new card or one old-card update, without changing IDs, draw/save/journal mechanics, or starting `three-of-swords`
