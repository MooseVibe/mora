...
- deck currently has 66 cards: 22 major arcana and 44 minor/court cards
- share-ready cards currently: `fool`, `magician`, `high-priestess`, `empress`, `emperor`, `hierophant`, `lovers`, `chariot`, `strength`, `hermit`, `wheel`, `justice`, `hanged-man`, `tower`, `two-of-cups`, `six-of-cups`, `ace-of-swords`, `page-of-cups`, `king-of-cups`, `queen-of-cups`, `king-of-wands`, `queen-of-wands`, `four-of-swords`, `five-of-swords`, `three-of-cups`, `four-of-cups`, `five-of-cups`, `ace-of-pentacles`, `two-of-pentacles`, `six-of-pentacles`, `three-of-pentacles`, `four-of-pentacles`, `five-of-pentacles`, `seven-of-pentacles`, `nine-of-pentacles`, `ten-of-pentacles`, `two-of-wands`, `four-of-wands`, `five-of-wands`, `six-of-wands`, `seven-of-wands`, `eight-of-wands`, `nine-of-wands`, `page-of-wands`, `page-of-swords`, `eight-of-cups`, `ten-of-cups`, `nine-of-cups`, `ten-of-wands`, `nine-of-swords`
- latest card addition: `five-of-swords` / «Пятёрка Мечей»; approved visual keeps Rider-Waite-Smith logic of one foreground victor collecting three swords, two swords on the ground and exactly two defeated people walking away, with a standard integrated `V` marker and three approved `preview/full/share` readings about the cost of winning a conflict
...
- cards-first continues in parallel one card per pass; latest pass added `five-of-swords` via `directives/04-add-tarot-cards.md`; next pass can be either one new card or one old-card text update, without changing card art, IDs, draw/save/journal mechanics, or starting `three-of-swords`
