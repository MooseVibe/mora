...
- В колоде 65 карт: 22 старших аркана и 43 пилотные младшие/придворные карты
...
Cards-first продолжается параллельно маленькими проходами: новая карта через visual/marker/text QA или старая карта через `preview/full/share`. Последний cards-first проход — `king-of-wands` / «Король Жезлов» добавлен как новая карта; следующий проход можно снова брать одной отдельной картой без смешивания с MLP отклика.
