...
4. ✅ Базовые metadata/SEO и OG-preview выпущены; после подключения домена обновить canonical URLs, проверить индексацию и провести закрытую бету 7–14 дней на 20–30 пользователях.
