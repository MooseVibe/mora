...
- В колоде 76 карт: 22 старших аркана и 54 пилотные младшие/придворные карты
...
Cards-first продолжается параллельно маленькими проходами: новая карта через visual/marker/text QA или старая карта через visual/marker и `preview/full/share`. Последний cards-first проход добавил `knight-of-swords` / «Рыцарь Мечей»; предыдущий проход обновил `sun` / «Солнце».
