...
- «Поделиться» открывает системный share sheet на mobile/touch с изображением карты, названием, утверждённым share-текстом варианта и ссылкой на Mora; если file-share недоступен, остаётся текстовый share. Desktop открывает браузерную отправку Telegram без изображения.
