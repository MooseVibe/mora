...
assert.match(app, /populateDailyResult\(savedDailyCard\.card[\s\S]*if \(usesMobileDailyResult\) updateDailyCooldownButton\(\)[\s\S]*classList\.remove\("daily-saved-pending"\)/);
...
assert.equal((html.match(/app\.js\?v=20260904-bootstrap1/g) || []).length, 2);
assert.match(html, /styles\.css\?v=20260904-bootstrap10/);
